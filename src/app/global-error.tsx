    ...
    <html lang="en">
      <body style={{ margin: 0, background: "#08060e", color: "#f9f7fc", fontFamily: "system-ui, sans-serif" }}>
        <main className="global-error-shell">
          <style>{`
            .global-error-shell{min-height:100vh;display:grid;place-items:center;padding:24px;box-sizing:border-box;text-align:center;background:linear-gradient(rgba(6,3,12,.74),rgba(6,3,12,.94)),url('/images/mazora-community-hero.png') center/cover}
          ...
          <section className="global-error-card">
            ...
            <img src="/images/mazora-logo.png" alt="Mazora Network" />
