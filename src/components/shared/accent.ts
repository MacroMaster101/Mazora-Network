...
export const accentStyles: Record<Accent, { text: string; border: string; bg: string; glow: string; hex: string }> = {
  // Text hues are the vivid tone on dark cards and a deeper tone of the same
  // hue on light cards, where the vivid ones fell to 2-4:1.
  green: { text: "text-[#6d28d9] dark:text-[#8b5cf6]", border: "border-[#8b5cf6]/40", bg: "bg-[#8b5cf6]/10", glow: "rgba(139,92,246,0.35)", hex: "#8b5cf6" },
  gold: { text: "text-gold", border: "border-gold/40", bg: "bg-gold/10", glow: "rgba(247,201,72,0.32)", hex: "#f7c948" },
  cyan: { text: "text-[#4338ca] dark:text-[#818cf8]", border: "border-[#818cf8]/40", bg: "bg-[#818cf8]/10", glow: "rgba(129,140,248,0.32)", hex: "#818cf8" },
  rose: { text: "text-[#a21caf] dark:text-[#e879f9]", border: "border-[#e879f9]/40", bg: "bg-[#e879f9]/10", glow: "rgba(232,121,249,0.32)", hex: "#e879f9" },
  violet: { text: "text-[#7e22ce] dark:text-[#a855f7]", border: "border-[#a855f7]/40", bg: "bg-[#a855f7]/10", glow: "rgba(168,85,247,0.32)", hex: "#a855f7" },
  orange: { text: "text-[#9333ea] dark:text-[#c084fc]", border: "border-[#c084fc]/40", bg: "bg-[#c084fc]/10", glow: "rgba(192,132,252,0.32)", hex: "#c084fc" },
};
